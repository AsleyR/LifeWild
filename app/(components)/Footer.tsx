export default function Footer() {
    return (
        <footer className="absolute bottom-0 inset-x-0 flex flex-col md:flex-row justify-center items-center gap-0 md:gap-1 text-base text-gray-500 text-center bg-[#f2f2f2] py-4 px-2 md:py-2 text-tgray drop-shadow-sm">
